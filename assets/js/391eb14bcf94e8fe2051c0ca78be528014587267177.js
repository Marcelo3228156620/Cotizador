...
$(function() {
    ...
    if ($('#frmchange').length > 0) {
        $('#frmchange').parsley();
        $('#frmchange').submit(function(e) { e.preventDefault(); if ($(this).parsley().isValid()) { $.post("/changePass/c", $(this).serialize(), function() { Swal.fire({ title: "Hecho", text: "Ha cambiado su contraseña", type: "success", showCancelButton: false, closeOnConfirm: true, }, function() { document.location = '/' }); }); } });
    }
