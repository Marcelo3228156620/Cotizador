    ...
    appearAnimate: function() {
      $('[data-appear-animation]').each(function(){
        $(this).appear(function() {
          var $this = $(this),
              delay = ($this.attr('data-appear-animation-delay') ? $this.attr('data-appear-animation-delay') : 1000),
              duration = ($this.attr('data-appear-animation-duration') ? $this.attr('data-appear-animation-duration') : 1000);
          ...
          $this.addClass($this.attr('data-appear-animation') + ' appear-animation-visible');
        });
      });
    }
  };
